...
class SSD1306_text {
 ...
 public:
  ...
  size_t writeHorizCentered(const char* s);
  void writeInt(int i);
  void fillRowRect(uint8_t x, uint8_t row_start, uint8_t w, bool white);
 ...
 private:
  ...
  #if USE_FRAME_BUFFER
  uint8_t frame_buf[SSD1306_LCDWIDTH*SSD1306_LCDHEIGHT/8] = {0};
  #endif
};
